...
import {InboxArrowDownIcon,PhoneIcon ,ArrowUpIcon ,UserIcon ,HomeIcon ,BookmarkIcon ,TableCellsIcon} from '@heroicons/react/24/solid'
type Props ={
  ...
  return (
    <div className='bg-[rgb(36,36,36)] text-white h-screen sanp-y snap-mandatory overflow-scroll z-0 main_container overflow-x-hidden'>
      <Head>
        ...
        <meta name="description" content="Hello, my name is Mellad Morshed. I am a front-end developer. This is my portfolio. I hope you like it❤️😊" />
